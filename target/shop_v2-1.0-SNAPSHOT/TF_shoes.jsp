...
<html>
    ...
    <body>
            ...
            <div class="container-fluid ">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav w-100 d-flex justify-content-cente" >
                        ...
                        <li class="nav-item mx-3">
                            <a class="nav-link" href="TF_shoes.jsp" style="font-weight: bold; color: red">TF Shoes</a>
                        </li>
                        <li class="nav-item mx-3">
        ...
        <div class="container mt-5">
            <h2 class="text-center">TF Shoes</h2>
            <div class="row">
                <%
                    ProductDAO dao = new ProductDAO();
                    List<Product> TFProducts = dao.getProductsByType("TF");
