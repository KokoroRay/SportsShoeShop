...
<html>
    ...
    <body>
                    ...
                    <ul class="navbar-nav w-100 d-flex justify-content-cente" >
                        ...
                        <li class="nav-item dropdown mx-3">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="adidas.jsp" style="color: red">Adidas</a></li>
        ...
        <h2 class="text-center">Adidas Shoes</h2>
        <div class="row">
            <%
                ProductDAO dao = new ProductDAO();
                List<Product> adidasProducts = dao.getProductsByBrand("Adidas");
                for (Product product : adidasProducts) {
            %>
